...
%define kernel_ver	4.18.0-425.19.2.el8_7
...
%changelog
* Tue Mar 21 2023 Yannick Cote <ycote@redhat.com> [0-0.el8]
- An empty patch to subscribe to kpatch stream for kernel-4.18.0-425.19.2.el8_7 [2180249]
